...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        glow: "0 0 40px -10px rgba(103, 232, 249, 0.25)",
        "glow-lg": "0 0 80px -20px rgba(103, 232, 249, 0.35)",
        soft: "0 8px 32px rgba(2, 6, 23, 0.5)",
      },
      backgroundImage: {
        "grid-fade":
          "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(103,232,249,0.15), transparent)",
        "noise":
